...
class GeminiProvider(BaseProvider):
    ...
    async def chat(self, request: ChatRequest) -> ChatResponse:
        raise ProviderModelNotSupportedError("Gemini provider is not yet implemented.")

    async def stream_chat(
        self,
        request: ChatRequest,
    ) -> AsyncGenerator[StreamChunk, None]:
        """Streaming is not yet implemented for Gemini."""
        raise ProviderModelNotSupportedError("Gemini streaming is not yet implemented.")
