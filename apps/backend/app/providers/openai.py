...
class OpenAIProvider(BaseProvider):
    """
    OpenAI API client wrapper (Placeholder).
    """
    ...
    async def chat(self, request: ChatRequest) -> ChatResponse:
        raise ProviderModelNotSupportedError("OpenAI provider is not yet implemented.")
    ...
    async def stream_chat(
        ...
        raise ProviderModelNotSupportedError("OpenAI streaming is not yet implemented.")
